...
namespace Otell
{
    public partial class FrmMusteriler : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=HASAN\\SQLEXPRESS;Initial Catalog=AycicegiPansiyon;Integrated Security=True;");
        ...
        {
            listView1.Items.Clear(); // ÖNEMLİ! Listeyi temizlemeden her defasında veri eklenirse tekrar olur
            baglanti.Open();
...
//Data Source=HASAN\SQLEXPRESS;Initial Catalog=AycicegiPansiyon;Integrated Security=True;Trust Server Certificate=True